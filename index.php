...
<?php
  ...
  <div class="main">
    ...
    <form class="form" action="login.php" method="POST">
      <input class="un" align="center" placeholder="Usuário" autofocus name="usuario">
      <input class="pass" type="password" align="center" placeholder="Senha" name="senha">
...
<style>
    ...
    .submit {
      cursor: pointer;
        border-radius: 5em;
        color: #fff;
        background: linear-gradient(to right, #312d31, #252325);
        border: 0;
        padding-left: 40px;
        padding-right: 40px;
        padding-bottom: 10px;
